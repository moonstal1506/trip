...
public class AttractionController {
    ...
    public ResponseEntity<?> findAllAttraction(){
        List<AttractionResponseDto> attractionResponseDtoList = attractionService.findAllAttraction();
        return new ResponseEntity<>(attractionResponseDtoList, HttpStatus.OK);
    }
